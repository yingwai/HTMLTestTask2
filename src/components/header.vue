        ...
        <div class="header">
            ...
            <div class="input-menu mobile">
                ...
                <svg
                    ...
                    viewBox="0 0 28 28"
                    fill="none"
                    @click="BurgerMenuStore.fSwitchBurgerMenu()"
                    v-if="!BurgerMenuStore.getBurgerMenu"
                >
                    <path
...
export default {
    ...
    methods: {
        ...
        fSwitchLanguage(language: string) {
